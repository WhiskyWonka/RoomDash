...
use Infrastructure\Tenant\Adapters\EloquentTenantRepository;
use Infrastructure\Tenant\Adapters\PostgresSchemaManager;
...
class TenancyServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(SchemaManagerInterface::class, PostgresSchemaManager::class);
    }
