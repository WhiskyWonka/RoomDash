...
use App\Docs\Endpoints\Api\UserEndpoints;
...
use Application\User\UseCases\ChangePasswordUseCase;
...
class UserController extends Controller implements UserEndpoints
{
    use ApiResponse;
    ...
    public function __construct(
        ...
        private readonly DeleteUserUseCase $deleteUseCase,
    ...
    public function update(UserUpdateRequest $request, string $id): JsonResponse
    {
        ...
        $useCaseRequest = new UpdateUserRequest(
            id: $id,
            username: $data['username'],
            firstName: $data['first_name'],
            lastName: $data['last_name'],
    ...
    public function destroy(Request $request, string $id): JsonResponse
    {
        ...
        try {
            $this->deleteUseCase->execute(new DeleteUserRequest(
                id: $id,
                actorId: $actorId,
                ipAddress: $request->ip(),
                userAgent: $request->userAgent(),
