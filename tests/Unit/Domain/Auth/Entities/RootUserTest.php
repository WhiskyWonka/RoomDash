...
it('creates root user with valid data', function () {
    // Arrange
    $id = 'user-uuid-1234';
...
it('serializes root user to json correctly', function () {
    // Arrange
...
it('detects active root user', function () {
    // Arrange & Act
    $user = new RootUser(
        id: 'user-uuid-1234',
        username: new Username('jdoe'),
...
it('detects inactive root user', function () {
    // Arrange & Act
    $user = new RootUser(
        id: 'user-uuid-1234',
        username: new Username('jdoe'),
